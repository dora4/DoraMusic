...
class CheckNetDialog(context: Context) : BaseDialog(context) {
    ...
    fun setListener(listener: OnPositiveListener) {
    ...
    private fun init() {
        ...
        mPositiveButton.setOnClickListener {
            if (this.onPositiveListener != null) {
                this.onPositiveListener!!.onConfirm()
            }
            dismiss()
        }
    ...
    override fun onCreateView(dialog: BaseDialog): View {
        return LayoutInflater.from(mContext).inflate(R.layout.dialog_check_net, null)
    }
}
